...
## Usage
Please see [godoc.org](http://godoc.org/github.com/schollz/gatt) for documentation.
...
Please check [#32](https://github.com/schollz/gatt/issues/32) for the status of this issue.
